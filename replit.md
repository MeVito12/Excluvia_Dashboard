...
- **RLS Policies Fix (Aug 2025)**: Added missing RLS policies for loyalty system tables (client_loyalty_points, coupons, loyalty_programs, loyalty_transactions) to resolve Supabase security warnings.
