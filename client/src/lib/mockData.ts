...
export const categoryProducts: Record<string, Product[]> = {
  ...
  alimenticio: [
    { id: 1, name: 'Pizza Margherita', category: 'pizzas', stock: 50, minStock: 10, price: 35.00, description: 'Pizza tradicional com manjericão fresco', isPerishable: true, expiryDate: '2025-01-15', manufacturingDate: '2025-01-12', status: 'Em Estoque', available: true },
    { id: 2, name: 'Hambúrguer Artesanal', category: 'hamburgueres', stock: 25, minStock: 8, price: 28.90, description: 'Hambúrguer 180g com fritas artesanais', isPerishable: true, expiryDate: '2025-01-14', manufacturingDate: '2025-01-13', status: 'Em Estoque', available: true },
    { id: 3, name: 'Lasanha Bolonhesa', category: 'massas', stock: 15, minStock: 5, price: 32.50, description: 'Lasanha tradicional com molho bolonhesa', isPerishable: true, expiryDate: '2025-01-16', manufacturingDate: '2025-01-12', status: 'Em Estoque', available: true },
    { id: 4, name: 'Salmão Grelhado', category: 'peixes', stock: 8, minStock: 3, price: 45.00, description: 'Salmão fresco grelhado com legumes', isPerishable: true, expiryDate: '2025-01-13', manufacturingDate: '2025-01-12', status: 'Em Estoque', available: true },
    { id: 5, name: 'Suco Natural de Laranja', category: 'bebidas', stock: 30, minStock: 15, price: 8.50, description: 'Suco natural de laranja 300ml', isPerishable: true, expiryDate: '2025-01-15', manufacturingDate: '2025-01-14', status: 'Em Estoque', available: true },
    ...
    { id: 7, name: 'Água Mineral 500ml', category: 'bebidas', stock: 80, minStock: 25, price: 3.50, description: 'Água mineral natural sem gás', isPerishable: false, expiryDate: '2026-12-31', manufacturingDate: '2024-01-15', status: 'Em Estoque', available: true },
    { id: 8, name: 'Tiramisù', category: 'sobremesas', stock: 12, minStock: 4, price: 15.90, description: 'Sobremesa italiana tradicional', isPerishable: true, expiryDate: '2025-01-18', manufacturingDate: '2025-01-15', status: 'Em Estoque', available: true },
    { id: 9, name: 'Sorvete Chocolate', category: 'sobremesas', stock: 6, minStock: 5, price: 12.00, description: 'Sorvete artesanal de chocolate', isPerishable: true, expiryDate: '2025-06-20', manufacturingDate: '2024-12-20', status: 'Em Estoque', available: true },
    { id: 10, name: 'Torta de Limão', category: 'sobremesas', stock: 8, minStock: 3, price: 18.50, description: 'Torta cremosa de limão siciliano', isPerishable: true, expiryDate: '2025-01-20', manufacturingDate: '2025-01-15', status: 'Em Estoque', available: true },
    { id: 11, name: 'Pão Francês', category: 'ingredientes', stock: 100, minStock: 30, price: 0.80, description: 'Pão francês tradicional fresquinho', isPerishable: true, expiryDate: '2025-01-13', manufacturingDate: '2025-01-12', status: 'Em Estoque', available: true },
    { id: 12, name: 'Leite Integral 1L', category: 'ingredientes', stock: 40, minStock: 15, price: 5.20, description: 'Leite integral pasteurizado', isPerishable: true, expiryDate: '2025-01-25', manufacturingDate: '2025-01-10', status: 'Em Estoque', available: true },
    ...
    { id: 15, name: 'Sanduíche Natural', category: 'pratos', stock: 12, minStock: 6, price: 18.50, description: 'Sanduíche integral com peito de peru', isPerishable: true, expiryDate: '2025-01-14', manufacturingDate: '2025-01-13', status: 'Em Estoque', available: true },
    { id: 16, name: 'Sopa de Legumes', category: 'pratos', stock: 18, minStock: 5, price: 16.90, description: 'Sopa caseira de legumes frescos', isPerishable: true, expiryDate: '2025-01-15', manufacturingDate: '2025-01-12', status: 'Em Estoque', available: true },
    { id: 17, name: 'Brownie de Chocolate', category: 'sobremesas', stock: 15, minStock: 5, price: 12.90, description: 'Brownie artesanal com chocolate belga', isPerishable: true, expiryDate: '2025-01-22', manufacturingDate: '2025-01-15', status: 'Em Estoque', available: true },
