    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Controle total dos seus produtos, vendas e clientes</p>
        </div>
      </div>
      ...
      <div className="unified-tabs">
        <button
          ...
          className={`unified-tab ${activeTab === 'produtos' ? 'active bg-orange-500' : 'inactive'}`}
        >
        ...
        <button
          ...
          className={`unified-tab ${activeTab === 'vendas' ? 'active bg-emerald-500' : 'inactive'}`}
        >
        ...
        <button
          ...
          className={`unified-tab ${activeTab === 'clientes' ? 'active bg-cyan-500' : 'inactive'}`}
        >
        ...
        <button
          ...
          className={`unified-tab ${activeTab === 'relatorios' ? 'active bg-indigo-500' : 'inactive'}`}
        >
