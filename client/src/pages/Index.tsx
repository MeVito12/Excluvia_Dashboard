...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[hsl(var(--dashboard-background))] to-[hsl(var(--dashboard-dark))] text-foreground relative overflow-hidden">
      {/* Background decorative elements - kept for visual appeal */}
